		...
		postcss: {
			...
			compressed: {
				...
				files: {
					...
					'dist/capture/capture.min.css': 'src/capture/capture.css',
					'dist/nextp/nextp.min.css': 'src/nextp/nextp.css',
					'dist/prevp/prevp.min.css': 'src/prevp/prevp.css',
					'dist/ptoggle/ptoggle.min.css': 'src/ptoggle/ptoggle.css'
				}
			},
		},
		copy: {
